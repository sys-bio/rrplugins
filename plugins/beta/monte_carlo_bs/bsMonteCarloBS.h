#ifndef bsMonteCarloBSH
#define bsMonteCarloBSH
#include <vector>
...
class MonteCarloBS : public CPPPlugin
{
    ...
    public:
                                                MonteCarloBS(PluginManager* manager);
                                               ~MonteCarloBS();
...
extern "C"
{
RR_PLUGIN_DECLSPEC MonteCarloBS*    plugins_cc       createPlugin(void* manager);
